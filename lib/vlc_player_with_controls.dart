...
import 'package:yesan_weather/controls_overlay.dart';
...
class VlcPlayerWithControlsState extends State<VlcPlayerWithControls> {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '상태: ${_controller.value.playingState.toString().split('.')[1]}',
  ...
  Future<void> _cyclePlaybackSpeed() async {
    ...
    return _controller.setPlaybackSpeed(playbackSpeeds.elementAt(playbackSpeedIndex));
  }
            ...
            content: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    title: Text(
                      index < subtitleTracks.keys.length ? subtitleTracks.values.elementAt(index) : 'Disable',
                    ),
                    onTap: () {
                      Navigator.pop(
                        context,
            ...
            content: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    title: Text(
                      index < audioTracks.keys.length ? audioTracks.values.elementAt(index) : 'Disable',
                    ),
                    onTap: () {
                      Navigator.pop(
                        context,
            ...
            content: SizedBox(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    title: Text(
                      index < castDevices.keys.length ? castDevices.values.elementAt(index) : 'Disconnect',
                    ),
                    onTap: () {
                      Navigator.pop(
                        context,
        ...
        child: Material(
          ...
          child: GestureDetector(
            ...
            onVerticalDragEnd: (dragEndDetails) {
              if ((initSnapshotBottomPosition - bottom).abs() >= _overlayWidth) {
                _overlayEntry?.remove();
                _overlayEntry = null;
              } else {
